"""
PDV Dos Mosqueteiros - Versão Aprimorada v3 (ajustado)
...
class PVDApp:
    def __init__(self, root):
        self.root = root
        root.title('PDV Dos Mosqueteiros - Aprimorado v3')
    ...
    def create_ui(self):
        ...
        topbar.pack(fill='x')
        title = ttk.Label(topbar, text='PDV Dos Mosqueteiros', font=('Arial', 14, 'bold'))
        ...
        self.products_tree = ttk.Treeview(left, columns=('price','sku','name'), show='headings', height=20)
        self.products_tree.heading('price', text='Preço')
        self.products_tree.heading('sku', text='SKU')
        self.products_tree.heading('name', text='Nome')
    ...
    def refresh_products(self):
        ...
        for p in self.products:
            ...
            '', 'end', iid=p['id'],
            values=(f"R$ {p['price']:.2f}", p['sku'] or '', p['name']))
